			...
			if(kernelcode==0)
			{
				...
				for ( int i=0; i< ntestsize; i++)
				{
					...
					if(isNtrainingPow2)
					{
						...
						{
							case 512:
								reductionrbf <512,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction, d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 256:
								reductionrbf <256,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 128:
								reductionrbf <128,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 64:
								reductionrbf <64,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 32:
								reductionrbf <32,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 16:
								reductionrbf <16,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  8:
								reductionrbf <8,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  4:
								reductionrbf <4,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  2:
								reductionrbf <2,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  1:
								reductionrbf <1,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
						}
					}
					else
					{
						...
						{
							case 512:
								reductionrbf <512,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 256:
								reductionrbf <256,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 128:
								reductionrbf <128,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 64:
								reductionrbf <64,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 32:
								reductionrbf <32,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case 16:
								reductionrbf <16,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  8:
								reductionrbf <8,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  4:
								reductionrbf <4,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  2:
								reductionrbf <2,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
							case  1:
								reductionrbf <1,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_ytraindata,d_atraindata,d_reduction,d_dottestdata, d_dottraindata,d_kdata,ntraining,ntestsize,i,beta); break;
						}
					}
					cudaThreadSynchronize();
