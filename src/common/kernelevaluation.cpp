...
#include "sgemv_mixedprecision.cu"
					...
					int kernelcode)
{
	...
	//sgemvn_mixedprecis <<<CTAS,THREAD_COUNT>>> (d_xtraindata,d_kernelrow,d_kerneldot,ntraining,	nfeatures,ntraining,1,1);
	...
	if(isNtrainingPow2)
	{
		...
		{
			case 512:
				SetKernelDot <512,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 256:
				SetKernelDot <256,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 128:
				SetKernelDot <128,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 64:
				SetKernelDot <64,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 32:
				SetKernelDot <32,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 16:
				SetKernelDot <16,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  8:
				SetKernelDot <8,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  4:
				SetKernelDot <4,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  2:
				SetKernelDot <2,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  1:
				SetKernelDot <1,true><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
		}
	}
	else
	{
		...
		{
			case 512:
				SetKernelDot <512,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 256:
				SetKernelDot <256,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 128:
				SetKernelDot <128,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 64:
				SetKernelDot <64,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 32:
				SetKernelDot <32,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case 16:
				SetKernelDot <16,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  8:
				SetKernelDot <8,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  4:
				SetKernelDot <4,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  2:
				SetKernelDot <2,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
			case  1:
				SetKernelDot <1,false><<< dimGridReduction, dimBlockReduction, smemSize >>>(d_kdata,d_dottraindata,d_kerneldot,gid,cacheid,ntraining,beta,kernelcode); break;
		}
	}
